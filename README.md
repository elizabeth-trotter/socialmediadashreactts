...
Created a single page Social Media Dashboard from a given prototype using `React`, `TypeScript`, and `TailwindCSS`

**Name:** Elizabeth Trotter

**Project Scope:** The goal was to recreate this challenge as close to the design as possible and include all functionality.


***Key Features:***

- Utilized given assets
- Built in React 
